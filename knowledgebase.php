...
$kb_categories = [
    [
        ...
        'questions' => [
            ['q' => 'Hosting nedir, ne ise yarar?', 'a' => 'Hosting (barındırma), web sitenizin internet uzerinde 7/24 erisilebilir olmasini sağlayan hizmettir. Web sitenizin dosyalarini bizim sunucularimiza yukluyorsunuz, biz de dunya genelinden gelen ziyaretcileri sitenize yonlendiriyoruz. Hosting olmadan web sitesi çalıştiramazsiniz.'],
            ['q' => 'NVMe SSD ile SATA SSD arasindaki fark nedir?', 'a' => 'NVMe SSD\'ler PCIe arabirimi uzerinden direkt CPU\'ya bağlanir, SATA SSD\'lere gore <strong>5-7 kat daha hızlı</strong> okuma/yazma yapar. Bizim sunucularimizda %100 NVMe SSD kullaniyoruz, bu sayede sitenin yuklenme süresi önemli ölçüde azaliyor.'],
            ...
            ['q' => 'Mevcut sitemi CODEGA\'ya nasıl taşırım?', 'a' => 'Hosting paketinizi aldıktan sonra panel üzerinden "Taşıma Talebi" oluşturun. Mevcut hosting bilgilerinizi (cPanel kullanıci adi/şifre veya FTP+veritabani) paylasin, uzman ekibimiz veri kaybi olmadan sitenizi taşır. <strong>5 siteye kadar UCRETSIZ taşıriz</strong>. Taşıma sirasinda sitenizin kesintisi 5-15 dakika arasi olur.'],
            ...
            ['q' => 'Domain ile hosting aynı firmadan olmalı mı?', 'a' => 'Hayır, aynı firmadan olması zorunlu değil. Ama aynı firmadan alınması yönetimi kolaylaştırırastirir, DNS ayarlari otomatik yapılir, fatura tek yere gelir. CODEGA\'dan hosting alir, domain\'iniz başka firmadaysa name server (NS) bilgilerini guncelleyerek bizimle çalışabilirsiniz.'],
        ],
    ],
    [
        'id' => 'domain',
        ...
        'questions' => [
            ...
            ['q' => 'Domain kayıt süresinin bitmesine ne kadar kaldi?', 'a' => 'Panel > Domain Yönetimi sekmesinde tüm domain\'lerinizin sona erme tarihlerini gorebilirsiniz. Sona ermesine 30 gun kala otomatik e-posta uyarisi gelir. Süreyi bitmeden uzatmak önemli, aksi takdirde başka biri tarafindan satin alinabilir.'],
    ...
    [
        ...
        'questions' => [
            ...
            ['q' => 'Sitemde malware var ne yapmalıyım?', 'a' => 'Imunify360 her hosting paketinde aktiftir ve dakikalık tarama yapar. Bir malware tespit edilirse otomatik karantinaya alırse panel uzerinden bildirim gelir, dosyalar otomatik karantinaya alinir. Manuel temizlik işterseniz destek talebi oluşturun, ekibimiz ücretsiz inceler.'],
            ['q' => '2FA (Iki Faktorlu Dogrulama) nasil aktif edilir?', 'a' => 'Hesabım > Güvenlik bolumune girin, "Iki Faktorlu Dogrulama" sekmesinden Google Authenticator veya Authy gibi bir uygulama ile QR kod tarayin. Böylece şifrenize ek olarak 6 haneli kod iştenir, hesabinizi koruma alti­na almis olursunuz.'],
    ...
    [
        ...
        'questions' => [
            ['q' => 'WordPress\'i tek tıkla nasıl kurulur?', 'a' => 'cPanel > Softaculous Apps Installer\'a girin, WordPress\'i seçip "Install Now" butonuna basınin. Site adi, admin kullanıci adi ve şifre belirleyin, dakikalar içinde kurulum tamamlanir. Veritabani otomatik oluşturulur, ekstra is yok.'],
            ...
            ['q' => 'Hangi WordPress eklentilerini önerirsiniz?', 'a' => 'Önerilenler: <strong>LiteSpeed Cache</strong> (hizlandirma), <strong>Wordfence</strong> (güvenlik), <strong>Yoast SEO</strong> (SEO), <strong>UpdraftPlus</strong> (yedekleme), <strong>WPForms</strong> (form), <strong>Elementor</strong> (sayfa kurucu). 30+ eklenti gerektigi durumlarda hosting paketinizi yukseltin.'],
            ...
            ['q' => 'WordPress otomatik güncelleme nasıl aktif edilir?', 'a' => 'wp-config.php\'a şu satırı ekleyin: <code>define("WP_AUTO_UPDATE_CORE", true);</code>. Böylece WordPress core, eklenti ve temalar otomatik guncellenir. Önerilen yöntem: Önemli guncellemelerden önce yedek alin, staging\'de test edin.'],
        ],
    ],
    [
        'id' => 'email',
        ...
        'desc' => 'E-posta hesabı oluşturma, kurulum ve sorun giderme',
        'questions' => [
            ['q' => '@domainim.com e-posta hesabını nasıl oluştururum?', 'a' => 'cPanel > E-posta Hesapları sekmesine girin, "Yeni Hesap Oluştur" tıklayıp kullanıcı adı belirleyinanıci adi ve şifreyi belirleyin. <code>info@domainim.com</code>, <code>destek@domainim.com</code> gibi sinirsiz hesap oluşturabilirsiniz (paket limitine gore).'],
    ...
    [
        ...
        'questions' => [
            ...
            ['q' => 'Ozel modül gelistirme yapıyor musunuz?', 'a' => 'Evet! Şirketinize ozel ihtiyaçlar için modül gelistiriyoruz. Ornek: ozel rapor ekranlari, harici sistem entegrasyonları (3. taraf yazılımlar, banka API), ozel formuller, sektörel ozelleskirilmis gorevler. Ücret modülun karmasikligina gore degisir, ortalama <strong>5.000-15.000 ₺</strong> arasi.'],
    ...
    [
        ...
        'questions' => [
            ...
            ['q' => 'İade nasıl işliyor?', 'a' => '<strong>30 gün içinde koşulsuz iade</strong> garantisi sunuyoruz. Hosting hizmetinden memnun kalmadıysanız, panel > Destek > İade Talebi oluşturun. Talep 1 is gunu içinde sonuçlandirilir, paranizin tamami orijinal odeme yöntemine geri yatirilir.'],
...
<section class="cdg-page-hero">
    ...
    <div class="cdg-container">
        <div class="cdg-page-hero-content">
            ...
            <h1>Aklınızdaki <span class="cdg-text-gradient">tüm sorulara</span> cevap burada</h1>
            <p>Hosting, domain, e-posta, WordPress, ERP ve yazılım hizmetlerimiz hakkında <strong><?php echo $total_questions; ?>+ soru ve cevap</strong>. Aradiginizi bulamazsaniz bize sorun, eklemeye devam ederiz.</p>
...
<section class="cdg-final-cta">
    <div class="cdg-container">
        <div class="cdg-final-cta-content">
            ...
            <h2>Sorunuzu cevapsız <span class="cdg-text-gradient">bırakmayalım</span></h2>
            <p>Burada cevap bulamadıysanız, ekibimize 7/24 ulaşabilirsiniz. Ortalama yanıt süreniz <strong>5 dakikadan az</strong>.</p>
