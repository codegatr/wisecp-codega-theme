...
$kb_categories = [
    ...
    [
        ...
        'questions' => [
            ...
            ['q' => 'WordPress otomatik güncelleme nasıl aktif edilir?', 'a' => 'wp-config.php\'a şu satırı ekleyin: <code>define("WP_AUTO_UPDATE_CORE", true);</code>. Böylece WordPress core, eklenti ve temalar otomatik guncellenir. Önerilen yöntem: Onemli guncellemelerden önce yedek alin, staging\'de test edin.'],
        ],
    ],
    [
        'id' => 'email',
