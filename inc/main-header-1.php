...
// === SINGLETON GUARD ===
// main-header-1.php aynı sayfada birden fazla kez include edilirse 2. çağrıda çık
if(defined('CDG_HEADER_RENDERED')) {
    return;
}
define('CDG_HEADER_RENDERED', true);
    ...
    <div class="cdg-container">
        <div class="cdg-header-inner">
            ...
            <div class="cdg-nav-actions">
                ...
                ?>
                <a href="<?php
                    // Once $basket_link runtime, sonra cdg_basket_link helper, son care cdg_link('basket')
                ...
                ?>" class="cdg-btn cdg-btn-ghost cdg-btn-sm cdg-cart-btn" title="Sepetim" aria-label="Sepetim">
