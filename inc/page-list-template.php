...
<section class="cdg-page-head">
    <div class="cdg-container">
        <h1><i class="bi bi-<?php echo htmlspecialchars($picon, ENT_QUOTES | ENT_HTML5, 'UTF-8'); ?>"></i> <?php echo htmlspecialchars($page_title, ENT_QUOTES | ENT_HTML5, 'UTF-8'); ?></h1>
            ...
            <main>
                ...
                <div class="cdg-list-items" style="display:grid;grid-template-columns:repeat(auto-fill,minmax(320px,1fr));gap:20px;">
                    ...
                    <article class="cdg-list-card cdg-card" style="overflow:hidden;display:flex;flex-direction:column;transition:transform 0.2s,box-shadow 0.2s;">
                        <a href="<?php echo htmlspecialchars($a_route, ENT_QUOTES | ENT_HTML5, 'UTF-8'); ?>" style="display:block;height:180px;overflow:hidden;background:<?php echo htmlspecialchars($pgrad, ENT_QUOTES | ENT_HTML5, 'UTF-8'); ?>;position:relative;">
                            <?php if($a_image): ?>
                        ...
                        <div style="padding:18px;flex:1;display:flex;flex-direction:column;">
                            <?php if($a_cat_name): ?>
                            <span style="display:inline-block;margin-bottom:8px;font-size:11px;font-weight:700;color:<?php echo htmlspecialchars($pcolor, ENT_QUOTES | ENT_HTML5, 'UTF-8'); ?>;text-transform:uppercase;letter-spacing:0.5px;">
                            ...
                            <div style="display:flex;align-items:center;justify-content:space-between;margin-top:auto;padding-top:10px;border-top:1px solid #f1f5f9;">
                                ...
                                <span></span>
                                <?php endif; ?>
                                <a href="<?php echo htmlspecialchars($a_route, ENT_QUOTES | ENT_HTML5, 'UTF-8'); ?>" style="font-size:12px;font-weight:700;color:<?php echo htmlspecialchars($pcolor, ENT_QUOTES | ENT_HTML5, 'UTF-8'); ?>;text-decoration:none;">
            ...
            <aside class="cdg-list-sidebar">
                ...
                <div class="cdg-card" style="padding:20px;margin-bottom:16px;">
                    <h4 style="font-size:14px;font-weight:800;color:#0f172a;margin:0 0 14px;">
                        <i class="bi bi-folder2-open" style="color:<?php echo htmlspecialchars($pcolor, ENT_QUOTES | ENT_HTML5, 'UTF-8'); ?>;"></i> Kategoriler
                    </h4>
                    <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:4px;">
                        ...
                        ?>
                        <li>
                            <a href="<?php echo htmlspecialchars($c_route, ENT_QUOTES | ENT_HTML5, 'UTF-8'); ?>" style="display:flex;justify-content:space-between;padding:8px 12px;text-decoration:none;color:<?php echo $is_active ? htmlspecialchars($pcolor, ENT_QUOTES | ENT_HTML5, 'UTF-8') : '#334155'; ?>;background:<?php echo $is_active ? '#f1f5f9' : 'transparent'; ?>;font-size:13px;font-weight:<?php echo $is_active ? '700' : '500'; ?>;border-radius:6px;">
