            ...
            <article class="cdg-kb-article cdg-card" style="padding:32px;font-family:'Plus Jakarta Sans',sans-serif;">
                <header style="margin-bottom:20px;padding-bottom:16px;border-bottom:1px solid #e2e8f0;">
                    ...
                    <div style="display:flex;gap:14px;font-size:12px;color:#64748b;flex-wrap:wrap;">
                        ...
                        <span><i class="bi bi-folder"></i> <a href="<?php echo htmlspecialchars($kb_category['route'] ?? '#', ENT_QUOTES | ENT_HTML5, 'UTF-8'); ?>" style="color:#2E3B4E;text-decoration:none;"><?php echo htmlspecialchars($kb_category['title'], ENT_QUOTES | ENT_HTML5, 'UTF-8'); ?></a></span>
                        <?php endif; ?>
                    </div>
                </header>
                ...
                <?php if($show_ticket): ?>
                <div style="margin-top:32px;padding:24px;background:linear-gradient(135deg,#eff6ff,#CFFAFE);border:1px solid #67E8F9;border-radius:12px;text-align:center;">
                    <div style="width:54px;height:54px;border-radius:50%;background:#fff;color:#2E3B4E;display:inline-grid;place-items:center;font-size:22px;margin-bottom:10px;box-shadow:0 4px 8px rgba(30,64,175,0.10);">
            ...
            <aside class="cdg-kb-sidebar" style="display:flex;flex-direction:column;gap:16px;">
                ...
                <div class="cdg-card" style="padding:20px;">
                    <h4 style="font-size:14px;font-weight:800;color:#0f172a;margin:0 0 14px;display:flex;align-items:center;gap:6px;">
                        <i class="bi bi-collection" style="color:#2E3B4E;"></i> Ilgili Makaleler
                    </h4>
                ...
                <div class="cdg-card" style="padding:20px;background:linear-gradient(135deg,#2E3B4E,#00D3E5);color:#fff;">
                    ...
                    <a href="<?php echo htmlspecialchars($kb_tickets_link, ENT_QUOTES | ENT_HTML5, 'UTF-8'); ?>" style="display:inline-flex;align-items:center;gap:6px;padding:8px 14px;background:#fff;color:#2E3B4E;text-decoration:none;border-radius:6px;font-size:12px;font-weight:700;">
...
.cdg-kb-content blockquote { border-left: 3px solid #00D3E5; background: #eff6ff; padding: 12px 16px; margin: 14px 0; border-radius: 0 8px 8px 0; color: #2E3B4E; }
...
.cdg-kb-content a { color: #2E3B4E; text-decoration: underline; }
